...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql_3 = ("select cnpj from pessoa where pes_login = '"+usuario+"' and pes_val = "+a+" ");
        if(bdc.BuscaCpfFis(sql_1)!= 0 || bdc.BuscaCnpjJur(sql_2)!= 0){
            if(bdc.BuscaCnpjJur(sql_3) != 0){
                JOptionPane.showMessageDialog(null,"Login","Bem Vindo",JOptionPane.INFORMATION_MESSAGE);
                InterfaceFazendeiro ifa = new InterfaceFazendeiro();
                InfoUsuario.setLogin(usuario);
                ifa.setVisible(true);
                this.dispose();
            }else{
                JOptionPane.showMessageDialog(null,"Login","Bem Vindo",JOptionPane.INFORMATION_MESSAGE);
                InterfaceCliente icl = new InterfaceCliente();
                icl.setVisible(true);
                InfoUsuario.setLogin(usuario);
                this.dispose();
            }
