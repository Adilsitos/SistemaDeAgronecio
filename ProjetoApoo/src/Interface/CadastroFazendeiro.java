 ...
 * @author adils
 */
public class CadastroFazendeiro extends javax.swing.JFrame {
   ...
   Class_Pessoa pj = new Class_Pessoa();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroFazendeiro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroFazendeiro().setVisible(true);
            }
        });
    }
