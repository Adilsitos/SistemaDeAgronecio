...
public static Animais setBuscaCPFAni(String sql){
		...
		try{
		    //Mostra lt = new Mostra();
                   ListarAnimal x = new ListarAnimal();
                   x.setVisible(true);
                   x.fbi(result);
        ...
        public static int buscaTel(String sql){
           ResultSet result = null;
                   int x = 0;
		try{
			getConect();
    ...
    public static String buscaEnd(String sql) {
       ResultSet result = null;
                   String x = null;
		try{
			getConect();
